        ...
        try {
            if ($this->customersession->isLoggedIn()) {
                if ($this->validateData()) {
                    ...
                    $dataPreclosure=$this->enrollmentProcess->changePreClosureEnrollmentStatus($post['enrollment_id']);
                    if ($dataPreclosure) {
                        $enrollmentDetail=$this->enrollmentProcess->getViewEnrollmentDetail($post['enrollment_id']);
                        $data=['status'=>true,'data'=>$enrollmentDetail];
