...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('KalyanUs_Scheme::Enrollment')
            ->addBreadcrumb(__('PG Scheme'), __('PG Scheme'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(KalyanUs\Scheme\Model\Enrollment::class);
        ...
        $this->_coreRegistry->register('enrollment', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->setActiveMenu('KalyanUs_Scheme::enrollment');
        $resultPage->addBreadcrumb(__('PG'), __('PG'));
